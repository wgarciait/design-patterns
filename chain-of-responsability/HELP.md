...
* The original package name 'com.example.pattern.chain-of-responsability' is invalid and this project uses 'com.example.pattern.chain_of_responsability' instead.
